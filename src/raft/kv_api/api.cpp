...
::grpc::Status Api_impl::get_rpc(::grpc::ServerContext* context,
...
::grpc::Status Api_impl::delete_rpc(::grpc::ServerContext* context,
                                    const ::store_request* request,
                                    ::store_response* response) {
...
::grpc::Status Api_impl::put_rpc(::grpc::ServerContext* context,
                                 const ::store_request* request,
                                 ::store_response* response) {
  ::log_request request_;
  response->set_ok(true);
